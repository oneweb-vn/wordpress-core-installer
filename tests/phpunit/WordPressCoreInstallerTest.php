...
namespace Tests\Onepress\Composer\phpunit;
...
use Onepress\Composer\WordPressCoreInstaller;
...
class WordPressCoreInstallerTest extends TestCase
{
    ...
    public function testTwoPackagesCannotShareDirectoryUnlessWpCoreType()
    {
        $composer  = $this->createComposer();
        $installer = new WordPressCoreInstaller(new NullIO(), $composer);
        $package1  = new Package('onepress/wordpress', '4.9.8', '4.9.8');
        $package1->setType('wordpress-core');
        $package2  = new Package('onepress/wordpress', '5.0', '5.0');
    ...
    {
        $prop = new \ReflectionProperty('\Onepress\Composer\WordPressCoreInstaller', '_installedPaths');
